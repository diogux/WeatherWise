        ...
        <div className="mt-20">
          ...
          <div className="mt-8 px-6 py-4 rounded-lg shadow-lg bg-white/60 max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-600 mt-4">
              ...
              forecasts, health advice, and travel tips. Our goal is to help
              users make informed decisions based on the weather conditions in
              their area.
            </p>
          </div>
          ...
          <div className="mt-8 px-6 py-4 rounded-lg shadow-lg bg-white/60 max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-600 mt-4">
              We are a diverse team of passionate software developers dedicated
              to delivering innovative solutions. Our combined expertise drives
              our mission to create impactful digital experiences that cater to
              our client's needs.
            </p>
          </div>
        </div>
