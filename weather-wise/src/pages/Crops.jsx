            ...
            <div className="w-1/4" style={{paddingRight: '20px'}}>
              <div className="border border-gray-300 rounded-md overflow-hidden">
                <div className="legend">
                  ...
                  <div className="legend-item " style={{ backgroundColor: '#FFF000' }}>60-74</div>
                  <div className="legend-item " style={{ backgroundColor: '#FFA900' }}>45-59</div>
                  <div className="legend-item " style={{ backgroundColor: '#EEA000' }}>30-44</div>
